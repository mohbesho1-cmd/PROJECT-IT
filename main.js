...
const movies = [
    {
        ...
        trailer: "YTDown_YouTube_THE-DRAMA-Official-Trailer-2-2026-Zenday_Media_g6WKGjpTSlE_004_360p.mp4"
    },
    {
        ...
        trailer: "YTDown.com_YouTube_Euphoria-Season-3-Episode-3-Preview-HBO-_Media_I1wmAQN_caY_001_1080p.mp4"
    },
    {
        ...
        trailer: "YTDown.com_YouTube_Daredevil-Born-Again-Season-2-Trailer-Di_Media_SkGd0zH1DE4_001_1080p.mp4"
    },
    {
        ...
        trailer: "YTDown.com_YouTube_Mortal-Kombat-II-Trailer-II-2026_Media_o7mTgt8Cb80_001_1080p (1).mp4"
    },
    {
        ...
        trailer: "YTDown.com_YouTube_THE-ODYSSEY-Official-Trailer-2026_Media_wvyNpWf3cZ0_001_1080p.mp4"
    }, {
        ...
        trailer: "YTDown_YouTube_SPIDER-MAN-4-Brand-New-Day-Official-Trai_Media_dbDcyf8S3ss_004_360p.mp4"
    },
    {
        ...
        poster: "The boys.jpg",
        trailer: "YTDown_YouTube_The-Boys-Season-5-2026-1-Trailer-Prime-V_Media_RIEQpkTwZYg_003_480p.mp4"
    }
];
...
function showMovie(index) {
    ...
    // Reset iframe and close overlay if open
...
function closeTrailer(event) {
    ...
    if (event && event.target !== document.getElementById("trailerOverlay") && !event.target.classList.contains("close-btn")) return;
